  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="sections" class="nav-link scrollto {{ Route::currentRouteName() == 'sections' ? 'active' : '' }}"><i class='bx bx-intersect'></i> <span>Sections</span></a></li>
        @endif
        ...
        @endif
        @if(Session::has('auth.role') && (Session::get('auth.role') == 1 || Session::get('auth.role') == 2) )
