...
__webpack_require__(/*! ./scanner */ "./resources/js/scanner.js");

__webpack_require__(/*! ./report */ "./resources/js/report.js");

__webpack_require__(/*! ./user */ "./resources/js/user.js"); // DTable.buttons().container().appendTo( '#report-table .col-md-6:eq(0)' );
...
if ($('#report-table').length) {
  var DTable = $('#report-table').DataTable({
    scrollX: true,
    language: {
      search: "",
...
if ($('#user-table').length) {
  ...
  $('#user-table tbody').on('click', 'tr', function () {
    $('#btnUserSubmit').hide();
    $('#btnUserUpdate').show();
    var d = DTable.row(this).data(); // selectedRow = d;
...
$('#btnUserSubmit').click(function (e) {
  e.preventDefault();
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('qr').then(function (res) {
    $('.disp-form').toggle();
    $('.disp-qr').show();
