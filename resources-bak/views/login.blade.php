...
<body>
  ...
  <script src="{{ URL::to('/public/assets/js/bs/jquery3.0.min.js') }}"></script>
  
  <script src="{{ URL::to('/public/assets/js/bs/popper.min.js') }}"></script>
  <script src="{{ URL::to('/public/assets/js/bs/bootstrap.bundle.min.js') }}"></script>
