  ...
  <!-- moment -->
  <script src="{{ URL::to('/public/assets/js/moment/moment.js') }}"></script>
  <script src="{{ URL::to('/public/assets/js/moment/moment-with-locales.js') }}"></script>
  ...
  <script src="{{URL::to('/public/js/node_modules_qr-scanner_qr-scanner-worker_min_js.js')}}"></script>
